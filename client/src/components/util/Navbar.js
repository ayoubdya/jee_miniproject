...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 z-40 w-full flex justify-between bg-raisin-black px-3">
      <Link to="/" className=" my-auto py-2">
        <img src="/images/logo-v2.png" alt="" className="h-10 my-auto" />
      </Link>
      <div className="flex">
        {!isSessionActive && (
