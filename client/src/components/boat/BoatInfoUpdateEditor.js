...
const BoatInfoUpdateEditor = ({ data, advertisementId }) => {
  ...
  const [fishingEquipment, setFishingEquipment] = useState(
    data.fishingEquipment.map((item) => item.name).join(", ")
  );
  ...
  const [navigationalEquipment, setNavigationalEquipment] = useState(
    data.navigationalEquipment.map((item) => item.name).join(", ")
  );
  ...
  return (
    <div className="block w-full">
      ...
      <div className="hidden text-left mt-4">
        <label className="text-xs">fishing equpiment</label>
        <input
          autoComplete="off"
          placeholder="fishing equipment separated by comma"
          onChange={(event) => {
            setFishingEquipment(event.target.value);
          }}
  ...
  focus:outline-none focus:border-gray-500 w-full caret-gray-700"
      ...
      <div className="hidden text-left mt-4">
        ...
        <input
          autoComplete="off"
          placeholder="navigational equipment separated by comma"
          onChange={(event) => {
            setNavigationalEquipment(event.target.value);
          }}
          value={navigationalEquipment}
          className="block rounded-lg px-3 border text-gray-700 border-gray-300 text-base py-2
  focus:outline-none focus:border-gray-500 w-full caret-gray-700"
        />
      </div>
      ...
      <div className="grid grid-cols-3 mt-2 gap-x-3">
        ...
        <div className="block col-span-1 text-left">
          ...
          <input
            autoComplete="off"
            onChange={(event) => {
              setBoatLength(event.target.value);
            }}
            value={boatLength}
            className="block rounded-lg px-3 border text-gray-700 border-gray-300 text-base py-2
            focus:outline-none focus:border-gray-500 w-full caret-gray-700"
        ...
        <div className="block col-span-1 text-left">
          ...
          <input
            autoComplete="off"
            onChange={(event) => {
              setBoatSpeed(event.target.value);
            }}
            value={boatSpeed}
            className="block rounded-lg px-3 border text-gray-700 border-gray-300 text-base py-2
            focus:outline-none focus:border-gray-500 w-full caret-gray-700"
