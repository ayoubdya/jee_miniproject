...
const RegistrationPage = () => {
  ...
  const {
    ...
    handleSubmit: handleSubmitFour,
    formState: { errors: errorsFour },
    clearErrors: clearErrorsFour,
    getValues: getValuesFour,
  } = useForm({
  ...
  const nextTwo = (data) => {
    if (
      ...
      handleNextAnimation();
    else setError("Reason must be between 20 and 500 characters in length.");
  };
  ...
  return (
    <div
      className="flex flex-col justify-center min-h-screen w-full h-full
    first-letter:font-display bg-slate-300"
    >
      {/* used to be bg-slate-500 */}
      {!isRegistrationSuccessful && (
        <div
          className="flex flex-col justify-between h-160 sm:h-140 bg-white w-11/12 sm:w-5/6 md:w-120
      rounded-xl mx-auto overflow-hidden px-4 sm:px-10 shadow-sm"
        >
          <div className="text-left">
            <h1 className="mt-6 sm:mt-8 text-xl sm:text-2xl tracking-widest text-center">
            ...
            >
              <div>
                <h2 className="mt-4 sm:mt-1 font-bold text-lg tracking-widest text-center text-slate-800">
                ...
                <div className="block sm:flex sm:flex-row sm:justify-center sm:gap-x-6 mt-6 sm:mt-10">
                  ...
                  ${
                    selectedRole === "client"
                      ? "border-cyan-700 hover:border-cyan-700"
                      : ""
                  }`}
                  >
                    <img
                      ...
                      alt=""
                      className="sm:h-24 sm:mx-auto"
                    />
                    <p className="font-display text-2xl sm:text-base text-center my-auto">
                      Customer
                    </p>
                  </div>
                  ...
                  <div
                    onClick={() => {
                      ...
                      setSelectedSubrole("resort-owner");
                    }}
                    className={`flex gap-x-5 sm:block w-full sm:w-36 h-20  sm:h-36 p-4 rounded-xl border-2 border-slate-100 hover:border-slate-200
                ...
                >
                  <div className="block sm:flex sm:flex-row sm:justify-center sm:gap-x-1 mt-3 sm:mt-6">
                    <div
                      onClick={() => setSelectedSubrole("resort-owner")}
                    ...
                    >
                      <img
                        src="/images/icons/building.png"
                        alt=""
                        className="p-1.5 sm:p-0  sm:h-12 sm:mx-auto"
                      />
                      <p className="font-display text-lg sm:text-sm text-center my-auto">
                        Resort Owner
                      </p>
                    </div>

                    <div
                      onClick={() => setSelectedSubrole("boat-owner")}
                      className={`flex gap-x-5 sm:block w-full sm:w-18 h-14 sm:h-24 sm:py-4 rounded-xl border-2
                    border-slate-100 hover:border-slate-200 cursor-pointer mt-1 sm:mt-0
                    ${
                      selectedSubrole === "boat-owner"
                        ? "border-cyan-700 hover:border-cyan-700"
                        : ""
                    }`}
                    >
                      <img
                        src="/images/icons/sailboat.png"
                        alt=""
                        className="p-1.5 sm:p-0 sm:h-12 sm:mx-auto"
                      />
                      <p className="font-display text-lg sm:text-sm text-center my-auto">
                    ...
                    {/* <div
                      onClick={() => setSelectedSubrole("instructor")}
                      className={`flex gap-x-5 sm:block w-full sm:w-18 h-14 sm:h-24 sm:py-4 rounded-xl border-2
                    border-slate-100 hover:border-slate-200 cursor-pointer mt-1 sm:mt-0
                    ${
                      selectedSubrole === "instructor"
                        ? "border-cyan-700 hover:border-cyan-700"
                        : ""
                    }`}
                    >
                      <img
                        src="/images/icons/fisherman.png"
                        alt=""
                        className="p-1.5 sm:p-0 sm:h-12 sm:mx-auto"
                      />
                      <p className="font-display text-lg sm:text-sm text-center my-auto">
            ...
            <CSSTransition
              classNames={`${
                previousSlide < nextSlide ? "inter-first" : "inter-second"
              }`}
              timeout={100}
            ...
            >
              <form
                autoComplete="off"
                id="registration-form-two"
                className="block mt-8"
                onSubmit={handleSubmitTwo(nextTwo)}
              >
                {/* <!-- email --> */}
                ...
                ${
                  errorsTwo.email?.message != null
                    ? "border-red-700 focus:border-red-700"
                    : ""
                }`}
                />
                <div className="h-2 mb-2">
                  <p className="text-xs text-red-500 my-0">
                    {errorsTwo.email?.message}
                  </p>
                </div>
                ...
                ${
                  errorsTwo.password?.message != null
                    ? "border-red-700 focus:border-red-700"
                    : ""
                }`}
                />
                ...
                focus:outline-none focus:border-gray-500 w-full caret-gray-700
                ${
                  errorsTwo.confirmPassword?.message != null
                    ? "border-red-700 focus:border-red-700"
                    : ""
                }`}
                />
                <div className="h-2 mb-2">
                  <p className="text-xs text-red-500 my-0">
                    {errorsTwo.confirmPassword?.message}
                  </p>
                </div>
                ...
                {selectedRole === "advertiser" && (
                  <div className="relative">
                    ...
                    <textarea
                      placeholder="I am a good candidate for receiving an advertiser account because..."
                      rows={3}
                      required
                      onChange={(event) => {
                  ...
                  hidden-scrollbar"
                    />
                    <div
                      className={`absolute select-none right-2 bottom-0 flex justify-end -mt-1 ${
                        reason.length > 500 || reason.length < 20
                          ? "text-slate-500"
                          : "text-green-700"
                      }`}
                    >
            ...
            >
              <form
                autoComplete="off"
                id="registration-form-three"
                className="block mt-8"
                onSubmit={handleSubmitThree(nextThree)}
              >
                {/* <!-- first name --> */}
                ...
                focus:outline-none focus:border-gray-500 w-full caret-gray-700
                ${
                  errorsThree.firstName?.message != null
                    ? "border-red-700 focus:border-red-700"
                    : ""
                }`}
                />
                ...
                focus:outline-none focus:border-gray-500 w-full caret-gray-700
                ${
                  errorsThree.lastName?.message != null
                    ? "border-red-700 focus:border-red-700"
                    : ""
                }`}
                />
                ...
                focus:outline-none focus:border-gray-500 w-full caret-gray-700
                ${
                  errorsThree.phoneNumber?.message != null
                    ? "border-red-700 focus:border-red-700"
                    : ""
                }`}
                />
                <div className="h-2">
                  <p className="text-xs text-red-500 my-0">
                    {errorsThree.phoneNumber?.message}
                  </p>
                </div>
            ...
            >
              <form
                autoComplete="off"
                id="registration-form-four"
                className="block mt-8"
                onSubmit={handleSubmitFour(submitAll)}
              >
                <label className="text-xs text-slate-500">address:</label>
                <input
                  name="address"
                  placeholder="address"
                  {...registerFour("address")}
                  onChange={() => {
                    clearErrorsFour();
                    setError("");
                  }}
                ...
                focus:outline-none focus:border-gray-500 w-full caret-gray-700
                ${
                  errorsFour.address?.message != null
                    ? "border-red-700 focus:border-red-700"
                    : ""
                }`}
                />
      ...
      {isRegistrationSuccessful && (
        <div
          className="flex flex-col justify-center h-160 sm:h-140 bg-white w-11/12 sm:w-5/6 md:w-120
        rounded-xl mx-auto overflow-hidden px-4 sm:px-10"
        >
          {selectedRole === "client" && (
            <div className="mb-16">
              <img
                src="/images/icons/check-mail.png"
                alt=""
                className="h-32 sm:h-24 mx-auto mb-4"
              />
          ...
          {selectedRole === "advertiser" && (
            <div className="mb-16">
              <img
                src="/images/icons/inspection.png"
                alt=""
                className="h-32 sm:h-24 mx-auto mb-4"
              />
              <h1 className="text-2xl sm:text-3xl tracking-widest text-center">
